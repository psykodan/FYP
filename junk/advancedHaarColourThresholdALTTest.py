...
from advancedHaarColourThresholdALT import advancedHaarDetectionColourThresholdImageStreamALT
...
def main():
	...
	for hSetNum in range(len(holdoutSets)):
		advancedHaarDetectionColourThresholdImageStreamALT(holdoutSets[hSetNum], cascade, threshold, box)
