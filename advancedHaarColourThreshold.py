...
def main():
	...
	DIR = str(input("Enter path to video file for Haar detection: ") or "/home/daniel/Documents/FYP/FYP/data/CloudyChopSurfFanore/positive/posCloudyChopSurfFanore4")
							...
							if(rects[a][0] <= x+box and rects[a][0] >= x-box and rects[a][1] <= y+box and rects[a][1] >= y-box):
								...
								for x in range(-1,2,1):
									for y in range(-1,2,1):
										if(gray_res[int(len(gray_res)/2)+x][int(len(gray_res[0])/2)+y] != 0):
											pos = pos + 1
