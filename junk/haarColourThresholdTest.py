...
from haarDetectColourThreshold import haarDetectionColourThresholdImageStream
...
def main():
	...
	for hSetNum in range(len(holdoutSets)):
		haarDetectionColourThresholdImageStream(holdoutSets[hSetNum], cascade, threshold)
